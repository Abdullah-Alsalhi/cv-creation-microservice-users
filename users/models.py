...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField(null=True, blank=True, error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 52 characters or fewer. Letters, digits and @/./+/-/_ only.',
                                max_length=52, unique=True, validators=[username_validator], verbose_name='username')
    ...
    objects = UserManager()  # here call the class which responsible for this model
    ...
    # check AbstractUser for email method in case you need it.
